...
type VerilogParserListener interface {
	...
	// EnterTimescale_directive is called when entering the timescale_directive production.
	EnterTimescale_directive(c *Timescale_directiveContext)
	...
	// EnterSetup_timing_check is called when entering the setup_timing_check production.
	EnterSetup_timing_check(c *Setup_timing_checkContext)

	// EnterHold_timing_check is called when entering the hold_timing_check production.
	EnterHold_timing_check(c *Hold_timing_checkContext)

	// EnterSetuphold_timing_check is called when entering the setuphold_timing_check production.
	EnterSetuphold_timing_check(c *Setuphold_timing_checkContext)

	// EnterRecovery_timing_check is called when entering the recovery_timing_check production.
	EnterRecovery_timing_check(c *Recovery_timing_checkContext)

	// EnterRemoval_timing_check is called when entering the removal_timing_check production.
	EnterRemoval_timing_check(c *Removal_timing_checkContext)

	// EnterRecrem_timing_check is called when entering the recrem_timing_check production.
	EnterRecrem_timing_check(c *Recrem_timing_checkContext)

	// EnterSkew_timing_check is called when entering the skew_timing_check production.
	EnterSkew_timing_check(c *Skew_timing_checkContext)

	// EnterTimeskew_timing_check is called when entering the timeskew_timing_check production.
	EnterTimeskew_timing_check(c *Timeskew_timing_checkContext)

	// EnterFullskew_timing_check is called when entering the fullskew_timing_check production.
	EnterFullskew_timing_check(c *Fullskew_timing_checkContext)

	// EnterPeriod_timing_check is called when entering the period_timing_check production.
	EnterPeriod_timing_check(c *Period_timing_checkContext)

	// EnterWidth_timing_check is called when entering the width_timing_check production.
	EnterWidth_timing_check(c *Width_timing_checkContext)

	// EnterNochange_timing_check is called when entering the nochange_timing_check production.
	EnterNochange_timing_check(c *Nochange_timing_checkContext)
	...
	// EnterData_event is called when entering the data_event production.
	EnterData_event(c *Data_eventContext)
	...
	// EnterReference_event is called when entering the reference_event production.
	EnterReference_event(c *Reference_eventContext)
	...
	// EnterEdge_control_specifier is called when entering the edge_control_specifier production.
	EnterEdge_control_specifier(c *Edge_control_specifierContext)
	...
	// EnterScalar_constant is called when entering the scalar_constant production.
	EnterScalar_constant(c *Scalar_constantContext)
	...
	// ExitTimescale_directive is called when exiting the timescale_directive production.
	ExitTimescale_directive(c *Timescale_directiveContext)
	...
	// ExitSetup_timing_check is called when exiting the setup_timing_check production.
	ExitSetup_timing_check(c *Setup_timing_checkContext)

	// ExitHold_timing_check is called when exiting the hold_timing_check production.
	ExitHold_timing_check(c *Hold_timing_checkContext)

	// ExitSetuphold_timing_check is called when exiting the setuphold_timing_check production.
	ExitSetuphold_timing_check(c *Setuphold_timing_checkContext)

	// ExitRecovery_timing_check is called when exiting the recovery_timing_check production.
	ExitRecovery_timing_check(c *Recovery_timing_checkContext)

	// ExitRemoval_timing_check is called when exiting the removal_timing_check production.
	ExitRemoval_timing_check(c *Removal_timing_checkContext)

	// ExitRecrem_timing_check is called when exiting the recrem_timing_check production.
	ExitRecrem_timing_check(c *Recrem_timing_checkContext)

	// ExitSkew_timing_check is called when exiting the skew_timing_check production.
	ExitSkew_timing_check(c *Skew_timing_checkContext)

	// ExitTimeskew_timing_check is called when exiting the timeskew_timing_check production.
	ExitTimeskew_timing_check(c *Timeskew_timing_checkContext)

	// ExitFullskew_timing_check is called when exiting the fullskew_timing_check production.
	ExitFullskew_timing_check(c *Fullskew_timing_checkContext)

	// ExitPeriod_timing_check is called when exiting the period_timing_check production.
	ExitPeriod_timing_check(c *Period_timing_checkContext)

	// ExitWidth_timing_check is called when exiting the width_timing_check production.
	ExitWidth_timing_check(c *Width_timing_checkContext)

	// ExitNochange_timing_check is called when exiting the nochange_timing_check production.
	ExitNochange_timing_check(c *Nochange_timing_checkContext)
	...
	// ExitData_event is called when exiting the data_event production.
	ExitData_event(c *Data_eventContext)
	...
	// ExitReference_event is called when exiting the reference_event production.
	ExitReference_event(c *Reference_eventContext)
	...
	// ExitEdge_control_specifier is called when exiting the edge_control_specifier production.
	ExitEdge_control_specifier(c *Edge_control_specifierContext)
	...
	// ExitScalar_constant is called when exiting the scalar_constant production.
	ExitScalar_constant(c *Scalar_constantContext)
